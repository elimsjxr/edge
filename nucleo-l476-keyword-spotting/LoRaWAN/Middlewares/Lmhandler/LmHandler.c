...
LmHandlerErrorStatus_t LmHandlerConfigure(LmHandlerParams_t *handlerParams)
{
  ...
  {
    ei_printf("error: Region is not defined in the MW: set lorawan_conf.h accordingly\r\n");
  ...
  ei_printf("###### DevEui:  %02X-%02X-%02X-%02X-%02X-%02X-%02X-%02X\r\n",
         HEX8(CommissioningParams.DevEui));
  ei_printf("###### AppEui:  %02X-%02X-%02X-%02X-%02X-%02X-%02X-%02X\r\n",
