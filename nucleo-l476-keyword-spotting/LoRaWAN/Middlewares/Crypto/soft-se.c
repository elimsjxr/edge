...
SecureElementStatus_t SecureElementInit(SecureElementNvmEvent seNvmCtxChanged)
{
  ...
  if (retval == SECURE_ELEMENT_SUCCESS)
  {
	  ei_printf("###### AppKey:  %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X\r\n", HEX16(keyItem->KeyValue));
  }
  retval = GetKeyByID(NWK_KEY, &keyItem);
  if (retval == SECURE_ELEMENT_SUCCESS)
  {
	  ei_printf("###### NwkKey:  %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X\r\n", HEX16(keyItem->KeyValue));
  }
  ei_printf("###### ABP  ######\r\n");
  retval = GetKeyByID(APP_S_KEY, &keyItem);
  if (retval == SECURE_ELEMENT_SUCCESS)
  {
    ei_printf("###### AppSKey: %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X\r\n", HEX16(keyItem->KeyValue));
  }
  retval = GetKeyByID(NWK_S_KEY, &keyItem);
  if (retval == SECURE_ELEMENT_SUCCESS)
  {
    ei_printf("###### NwkSKey: %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X %02X\r\n", HEX16(keyItem->KeyValue));
  }
#else /* LORAWAN_KMS == 1 */
  uint8_t itr = 0;
